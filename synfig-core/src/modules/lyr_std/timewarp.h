...
#ifndef __SYNFIG_TIMEWARP_H
#define __SYNFIG_TIMEWARP_H
...
/**
  Re-implementation of the TimeLoop without bothering to maintain compatibility.
 */
class Layer_TimeWarp : public Layer
{
	SYNFIG_LAYER_MODULE_EXT

private:
	//! Parameter: (Time)
	ValueBase param_time_shift;
	//! Parameter: (Time)
	ValueBase param_anim_origin;
	//! Parameter: (Time)
	ValueBase param_anim_duration;
	//! Parameter: (bool)
	ValueBase param_ignore_negative_offset;
	//! Parameter: (bool)
