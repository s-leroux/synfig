...
**	\brief Header file for implementation of the "Time Scale" valuenode conversion.
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_VALUENODE_TIMESCALE_H
#define __SYNFIG_VALUENODE_TIMESCALE_H
...
struct ValueNode_TimeScale : public LinkableValueNode
{
	typedef etl::handle<ValueNode_TimeScale> Handle;
	typedef etl::handle<const ValueNode_TimeScale> ConstHandle;

private:
	ValueNode::RHandle value_node;
	ValueNode::RHandle origin;
	ValueNode::RHandle scale;

	ValueNode_TimeScale(const ValueBase &value);
...
public:
	...
	static ValueNode_TimeScale* create(const ValueBase &x);
	virtual Vocab get_children_vocab_vfunc()const;
}; // END of class ValueNode_TimeScale
